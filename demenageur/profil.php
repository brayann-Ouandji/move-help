...
$photo_path = '../img/default_profil.png'; 
                ...
                <form action="../actions/traitement_profil_demenageur.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="ville" name="ville" value="<?php echo $dem_info['ville']; ?>">
                        </div>
                         <div class="col-md-6 mb-3">
                            <label for="experience" class="form-label">Expérience (années)</label>
                            <input type="number" class="form-control" id="experience" name="experience" min="0" value="<?php echo $dem_info['experience']; ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="vehicule" class="form-label">Véhicule disponible</label>
                        <select class="form-select" id="vehicule" name="vehicule">
                            <option value="non" <?php if(empty($dem_info['vehicule_disponile'])) echo 'selected'; ?>>Non</option>
